...
def HMMResult(identifier, start, end, evalue, bitscore, query_id="dummy_query", **kwargs):
    return RealHit(query_id=query_id, reference_id=identifier, query_start=start, query_end=end,
...
class TestFunctionResults(unittest.TestCase):
    ...
    def test_results_reconstruction(self):
        def check_results(results):
            ...
            assert isinstance(results.best_hits["cds1"], RealHit)
